class DeCraftCamoNet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Camo netting into strips";
		...
		//result1
		AddResult("CamoNetStrip");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		...
		switch ( hp )
		{
			...
			case GameConstants.STATE_RUINED:
				results[0].SetQuantity(Math.RandomIntInclusive( 1, 4 ));
